...
import { MessageCircle, Phone, Video, Mail, MapPin, Building, User, Star } from 'lucide-react'
...
const ContactGrid = () => {
  ...
  const [s2tUsers, setS2tUsers] = useState([]);
  ...
  const loadUsers = async () => {
    try {
      ...
      // Load startups, experts, and S2T users
      const [startupsRes, expertsRes, s2tRes] = await Promise.all([
        messagingService.getStartups(),
        messagingService.getExperts(),
        messagingService.getS2TUsers()
      ]);

      setStartups(startupsRes.data || []);
      setExperts(expertsRes.data || []);
      setS2tUsers(s2tRes.data || []);
    } catch (error) {
  ...
  <div className="content">
    ...
    <div className="card mb-4">
      <div className="card-body">
        <h5 className="mb-3">💬 Smart Tunisienne Technopark Messaging</h5>
        <p className="text-muted mb-0">
          Connect with startups, experts, and S2T team members. Start conversations, share ideas, and collaborate in real-time.
        </p>
      </div>
    </div>
        ...
        {isLoading ? (
          ...
          <div className="row">
            {startups.map((startup: any) => (
              <div key={startup._id} className="col-xl-3 col-lg-4 col-md-6 mb-3">
                <div className="card h-100 border-0 shadow-sm">
                  <div className="card-body text-center">
                    <div className="mb-3">
                      <div className="avatar avatar-xl avatar-rounded mx-auto">
                        <ImageWithBasePath
                          src={startup.profilePhoto || 'assets/img/users/user-01.jpg'}
                          className="img-fluid h-auto w-auto"
                          alt={startup.firstName}
                        />
                      </div>
                    </div>
                    <h6 className="mb-1">{startup.firstName} {startup.lastName}</h6>
                    <span className="badge bg-success-transparent fs-10 fw-medium mb-2">
                      Startup
                    </span>
                    <p className="text-muted small mb-2">{startup.email}</p>
                    
                    <div className="d-flex justify-content-center gap-2">
                      <button
                        onClick={() => openChat(startup)}
                      ...
                      <button className="btn btn-outline-primary btn-sm" title="Voice Call">
                        <Phone size={16} />
                      </button>
                      <button className="btn btn-outline-primary btn-sm" title="Video Call">
                        <Video size={16} />
                      </button>
                    </div>
                  </div>
        ...
        {isLoading ? (
          ...
          <div className="row">
            {experts.map((expert: any) => (
              <div key={expert._id} className="col-xl-3 col-lg-4 col-md-6 mb-3">
                <div className="card h-100 border-0 shadow-sm">
                  <div className="card-body text-center">
                    <div className="mb-3">
                      <div className="avatar avatar-xl avatar-rounded mx-auto">
                        <ImageWithBasePath
                          src={expert.profilePhoto || 'assets/img/users/user-01.jpg'}
                          className="img-fluid h-auto w-auto"
                          alt={expert.firstName}
                        />
                      </div>
                    </div>
                    <h6 className="mb-1">{expert.firstName} {expert.lastName}</h6>
                    <span className="badge bg-warning-transparent fs-10 fw-medium mb-2">
                      Expert
                    </span>
                    <p className="text-muted small mb-2">{expert.email}</p>
                    {expert.department && (
    ...
    <div className="card mb-4">
      ...
      <div className="card-body">
        {isLoading ? (
          ...
          <div className="row">
            {s2tUsers.map((s2tUser: any) => (
              <div key={s2tUser._id} className="col-xl-3 col-lg-4 col-md-6 mb-3">
                <div className="card h-100 border-0 shadow-sm">
                  <div className="card-body text-center">
                    <div className="mb-3">
                      <div className="avatar avatar-xl avatar-rounded mx-auto">
                        <ImageWithBasePath
                          src={s2tUser.profilePhoto || 'assets/img/users/user-01.jpg'}
                          className="img-fluid h-auto w-auto"
                          alt={s2tUser.firstName}
                        />
                      </div>
                    </div>
                    <h6 className="mb-1">{s2tUser.firstName} {s2tUser.lastName}</h6>
                    <span className="badge bg-info-transparent fs-10 fw-medium mb-2">
                      S2T Team
                    </span>
                    <p className="text-muted small mb-2">{s2tUser.email}</p>
                    {s2tUser.position && (
                      <p className="text-muted small mb-2">
                        <Building size={14} className="me-1" />
                        {s2tUser.position}
