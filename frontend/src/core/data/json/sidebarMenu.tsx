...
export const SidebarDataTest = [
  {
    ...
    submenuItems: [
      {
        label: 'Dashboard',
        link: null,                // ❌ pas "index" → sinon conflit avec le submenu
        submenu: true,             // ✅ c’est un menu avec sous-menu
        base: 'dashboard',
        icon: 'smart-home',
        materialicons: 'start',
        dot: true,
        submenuItems: [            // ✅ sous-menu des dashboards
    ...
    submenuItems: [
      ...
      },
      {
          ...
          submenuItems: [
            {
              label: 'Ticket List',
              link: routes.ticketList,
              base: 'ticket-list',
            },
            {
              label: 'Ticket Grid',
              link: routes.ticketGrid,
              base: 'ticket-grid',
            },
            {
      ...
      },
      {
        ...
        submenuItems: [
          ...
          // --- Add new button for Company Profile Statistics ---
          {
            ...
            link:  routes.companyOverviewDashboard, // or routes.companyOverviewDashboard if defined
